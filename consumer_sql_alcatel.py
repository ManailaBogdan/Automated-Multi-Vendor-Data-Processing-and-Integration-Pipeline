...
class Alcatel(ConsumerSQL):
    '''
    Class for taking data from RabbitMQ Alcatel queue
    and adding it to MySQL Alcatel table
    ...
    def __init__(self):
        ...
        result = self.channel.queue_declare(**config.alcatel_sql_queue)
        self.queue = result.method.queue
        self.channel.queue_bind(**config.alcatel_sql_bind)

        self.table_prefix = config.alcatel_table
